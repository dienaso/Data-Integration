...
public class LoginController extends BaseController {
	...
	*/  
	@RequestMapping(value = {"/stat/login/loginType"})
    public ModelAndView loginTypeStat() throws SolrServerException, IOException {
		...
		//返回视图
		ModelAndView mv = new ModelAndView("stat/login/loginType");
		//总数
	 ...
	 */
	@RequestMapping(value = "/login/loginDetail/get", method = RequestMethod.GET, produces = "application/json;charset=UTF-8")
	 ...
	 * @version 创建时间：2015年6月10日 下午3:28:27
	 */
	@RequestMapping(value = { "/stat/login/loginDetail" })
	public ModelAndView loginDetail() throws SolrServerException, IOException {
		// 返回视图
		ModelAndView mv = new ModelAndView("stat/login/loginDetail");
